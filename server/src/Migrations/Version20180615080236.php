 ...
 */
final class Version20180615080236 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE like_works (like_id INT NOT NULL, works_id INT NOT NULL, INDEX IDX_41812BA4859BFA32 (like_id), INDEX IDX_41812BA4F6CB822A (works_id), PRIMARY KEY(like_id, works_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
